...
public class AccountTypeController {
    ...
    public  AccountTypeController(FetchAccountTypeFlow fetchAccountTypeFlow,
                                  @Qualifier("createAccountTypeFlowName") CreateAccountTypeFlow createAccountTypeFlow, ModifyAccountTypeFlow modifyAccountTypeFlow, ModifyAccountTypeFlow modifyAccountTypeFlow1) {
    ...
    @GetMapping("{mnemonic}")
    @ApiOperation(value = "Fetches the specified AccountType.", notes = "Fetchs the AccountType corresponding to the given mnemonic.")
    @ApiResponses(value = {
    ...
    public ResponseEntity<GeneralResponse<AccountTypeDto>> updateAccountType(
            ...
            @ApiParam(value = "The optional new date with which to update the CreationDate in ISO date format (yyy-MM-dd)\r\nIf empty/null it will not be updated",
